...
class show_salary(object):
    ...
    def setup_ui(self):
        ...
        self.tree["columns"]=("time","name","lock_num","stock_num","barrel_num","sale_amount")  
    ...
    def showSalaryData(self,data):
        self.tree.insert("",data[0],text=str(data[0]) ,values=(data[1],data[2],data[3],data[4],data[5],data[6]))
